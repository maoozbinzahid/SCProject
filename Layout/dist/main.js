...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar likeButton = exports.likeButton = document.getElementById(\"addToLikes\");\nvar favouriteButton = exports.favouriteButton = document.getElementById(\"favourites\");\nvar like_icon = exports.like_icon = document.getElementById('like_icon');\n\n//# sourceURL=webpack:///./LikesView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _regenerator = __webpack_require__(/*! babel-runtime/regenerator */ \"./node_modules/babel-runtime/regenerator/index.js\");\n\nvar _regenerator2 = _interopRequireDefault(_regenerator);\n\nvar _asyncToGenerator2 = __webpack_require__(/*! babel-runtime/helpers/asyncToGenerator */ \"./node_modules/babel-runtime/helpers/asyncToGenerator.js\");\n\nvar _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);\n\nvar _classCallCheck2 = __webpack_require__(/*! babel-runtime/helpers/classCallCheck */ \"./node_modules/babel-runtime/helpers/classCallCheck.js\");\n\nvar _classCallCheck3 = _interopRequireDefault(_classCallCheck2);\n\nvar _createClass2 = __webpack_require__(/*! babel-runtime/helpers/createClass */ \"./node_modules/babel-runtime/helpers/createClass.js\");\n\nvar _createClass3 = _interopRequireDefault(_createClass2);\n\nvar _axios = __webpack_require__(/*! ./node_modules/axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar shoppingList = function () {\n\tfunction shoppingList(recipeClicked, JSONResponse) {\n\t\t(0, _classCallCheck3.default)(this, shoppingList);\n\n\t\tthis.index = recipeClicked;\n\t\tthis.response = JSONResponse;\n\t}\n\n\t(0, _createClass3.default)(shoppingList, [{\n\t\tkey: \"getIngred\",\n\t\tvalue: function () {\n\t\t\tvar _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {\n\t\t\t\tvar rec, ing, quantity, res, result, Ingredients, fractionStringToNumber, i, clean, q, temp, toBePushed, t, x, y;\n\t\t\t\treturn _regenerator2.default.wrap(function _callee$(_context) {\n\t\t\t\t\twhile (1) {\n\t\t\t\t\t\tswitch (_context.prev = _context.next) {\n\t\t\t\t\t\t\tcase 0:\n\t\t\t\t\t\t\t\trec = this.response[this.index].recipe_id;\n\t\t\t\t\t\t\t\ting = [];\n\t\t\t\t\t\t\t\tquantity = [];\n\t\t\t\t\t\t\t\t_context.prev = 3;\n\t\t\t\t\t\t\t\tres = (0, _axios2.default)(\"https://forkify-api.herokuapp.com/api/get?rId=\" + rec);\n\t\t\t\t\t\t\t\t_context.next = 7;\n\t\t\t\t\t\t\t\treturn res;\n\n\t\t\t\t\t\t\tcase 7:\n\t\t\t\t\t\t\t\tresult = _context.sent.data;\n\n\t\t\t\t\t\t\t\tconsole.log(result.recipe);\n\t\t\t\t\t\t\t\tIngredients = result.recipe.ingredients;\n\n\t\t\t\t\t\t\t\tfractionStringToNumber = function fractionStringToNumber(s) {\n\t\t\t\t\t\t\t\t\treturn s.split(\"/\").map(function (s) {\n\t\t\t\t\t\t\t\t\t\treturn Number(s);\n\t\t\t\t\t\t\t\t\t}).reduce(function (a, b) {\n\t\t\t\t\t\t\t\t\t\treturn a / b;\n\t\t\t\t\t\t\t\t\t});\n\t\t\t\t\t\t\t\t};\n\n\t\t\t\t\t\t\t\tfor (i = 0; i < Ingredients.length; i++) {\n\t\t\t\t\t\t\t\t\tclean = Ingredients[i].replace(/ *\\([^)]*\\) */g, ' ');\n\t\t\t\t\t\t\t\t\tq = clean.match(/(?:[1-9][0-9]*|0)(?:\\/[1-9][0-9]*)?/);\n\n\n\t\t\t\t\t\t\t\t\tif (q == null) {\n\t\t\t\t\t\t\t\t\t\ting.push(clean);quantity.push(\"-\");\n\t\t\t\t\t\t\t\t\t} else {\n\n\t\t\t\t\t\t\t\t\t\tquantity.push(q[0]);\n\n\t\t\t\t\t\t\t\t\t\ttemp = clean.split(quantity[i]);\n\n\n\t\t\t\t\t\t\t\t\t\tif (temp.length > 2) {\n\t\t\t\t\t\t\t\t\t\t\ttoBePushed = temp[1] + temp[2];\n\t\t\t\t\t\t\t\t\t\t} else {\n\t\t\t\t\t\t\t\t\t\t\ttoBePushed = temp[1];\n\t\t\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\t\t\t\tt = toBePushed.match(/(?:[1-9][0-9]*|0)(?:\\/[1-9][0-9]*)?/);\n\n\n\t\t\t\t\t\t\t\t\t\tif (t != null) {\n\t\t\t\t\t\t\t\t\t\t\tquantity.pop();\n\t\t\t\t\t\t\t\t\t\t\tx = fractionStringToNumber(q[0]);\n\t\t\t\t\t\t\t\t\t\t\ty = fractionStringToNumber(t[0]);\n\n\n\t\t\t\t\t\t\t\t\t\t\tquantity.push(String(x * y));\n\t\t\t\t\t\t\t\t\t\t\ttoBePushed = toBePushed.split(t[0])[1];\n\t\t\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\t\t\t\ting.push(toBePushed);\n\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\t\t//Convertig to proper format ( From string to numbers)\n\t\t\t\t\t\t\t\tfor (i = 0; i < quantity.length; i++) {\n\t\t\t\t\t\t\t\t\tif (fractionStringToNumber(quantity[i]) === quantity[i]) {\n\t\t\t\t\t\t\t\t\t\tquantity[i] = parseInt(quantity[i]);\n\t\t\t\t\t\t\t\t\t} else {\n\t\t\t\t\t\t\t\t\t\tif (quantity[i] == \"-\") {\n\t\t\t\t\t\t\t\t\t\t\tquantity[i] = \"-\";\n\t\t\t\t\t\t\t\t\t\t} else {\n\t\t\t\t\t\t\t\t\t\t\tquantity[i] = fractionStringToNumber(quantity[i]).toFixed(2);\n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\t\t_context.next = 18;\n\t\t\t\t\t\t\t\tbreak;\n\n\t\t\t\t\t\t\tcase 15:\n\t\t\t\t\t\t\t\t_context.prev = 15;\n\t\t\t\t\t\t\t\t_context.t0 = _context[\"catch\"](3);\n\t\t\t\t\t\t\t\talert(_context.t0);\n\n\t\t\t\t\t\t\tcase 18:\n\n\t\t\t\t\t\t\t\tconsole.log(ing);\n\t\t\t\t\t\t\t\tconsole.log(quantity);\n\n\t\t\t\t\t\t\t\tthis.n = ing;\n\t\t\t\t\t\t\t\tthis.q = quantity;\n\n\t\t\t\t\t\t\tcase 22:\n\t\t\t\t\t\t\tcase \"end\":\n\t\t\t\t\t\t\t\treturn _context.stop();\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}, _callee, this, [[3, 15]]);\n\t\t\t}));\n\n\t\t\tfunction getIngred() {\n\t\t\t\treturn _ref.apply(this, arguments);\n\t\t\t}\n\n\t\t\treturn getIngred;\n\t\t}()\n\t}]);\n\treturn shoppingList;\n}();\n\nexports.default = shoppingList;\n\n//# sourceURL=webpack:///./List.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar checkoutButton = exports.checkoutButton = document.getElementById('check-out-btn');\nvar i = exports.i = document.getElementsByClassName(\"qty\");\nvar ingredients = exports.ingredients = document.getElementById(\"Ingredients\");\nvar def_serving = exports.def_serving = document.getElementsByClassName(\"fa-users\")[0];\n\n//# sourceURL=webpack:///./ListView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar searchButton = exports.searchButton = document.getElementById('search_btn');\nvar searchBox = exports.searchBox = document.getElementById(\"searchbox\");\nvar output = exports.output = document.getElementById(\"second_column\");\n\n//added by Maooz\n\nvar column1 = exports.column1 = document.getElementById('1st_column');\n\n//# sourceURL=webpack:///./SearchView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar calculateServing = exports.calculateServing = function calculateServing(ing, qty) {\n  var qd = 0;\n  var i;\n  for (i = 0; i < qty.length; i++) {\n    var q = qty[i];\n\n    if (q != \"-\") {\n      q = parseFloat(q);\n      q = q % 10;\n      qd = qd + parseFloat(q);\n    }\n  }\n  console.log(\"hello ji ji\" + qd);\n  qd = qd / i;\n\n  if (ing.length > 8) {\n    qd = qd * ing.length / 2;\n  } else {\n    qd = qd * ing.length + 1;\n  }\n\n  return qd;\n};\n\n//# sourceURL=webpack:///./recipe.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar recipe_column = exports.recipe_column = document.getElementById(\"second_column\");\nvar rname = exports.rname = document.getElementById(\"rname\");\nvar rimage = exports.rimage = document.getElementById(\"rimage\");\nvar rdesc = exports.rdesc = document.getElementById(\"rdesc\");\nvar rmain = exports.rmain = document.getElementById(\"rmain\");\nvar rqty = exports.rqty = document.getElementById(\"rqty\");\nvar rate = exports.rate = document.getElementById(\"rate\");\n\n//# sourceURL=webpack:///./recipeView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _regenerator = __webpack_require__(/*! babel-runtime/regenerator */ \"./node_modules/babel-runtime/regenerator/index.js\");\n\nvar _regenerator2 = _interopRequireDefault(_regenerator);\n\nvar _asyncToGenerator2 = __webpack_require__(/*! babel-runtime/helpers/asyncToGenerator */ \"./node_modules/babel-runtime/helpers/asyncToGenerator.js\");\n\nvar _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);\n\nvar _classCallCheck2 = __webpack_require__(/*! babel-runtime/helpers/classCallCheck */ \"./node_modules/babel-runtime/helpers/classCallCheck.js\");\n\nvar _classCallCheck3 = _interopRequireDefault(_classCallCheck2);\n\nvar _createClass2 = __webpack_require__(/*! babel-runtime/helpers/createClass */ \"./node_modules/babel-runtime/helpers/createClass.js\");\n\nvar _createClass3 = _interopRequireDefault(_createClass2);\n\nvar _axios = __webpack_require__(/*! ./node_modules/axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar Search = function () {\n\tfunction Search(q) {\n\t\t(0, _classCallCheck3.default)(this, Search);\n\n\t\tthis.query = q;\n\t}\n\n\t(0, _createClass3.default)(Search, [{\n\t\tkey: \"getResults\",\n\t\tvalue: function () {\n\t\t\tvar _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {\n\t\t\t\tvar res;\n\t\t\t\treturn _regenerator2.default.wrap(function _callee$(_context) {\n\t\t\t\t\twhile (1) {\n\t\t\t\t\t\tswitch (_context.prev = _context.next) {\n\t\t\t\t\t\t\tcase 0:\n\t\t\t\t\t\t\t\t_context.prev = 0;\n\t\t\t\t\t\t\t\tres = (0, _axios2.default)(\"http://forkify-api.herokuapp.com/api/search?q=\" + this.query);\n\t\t\t\t\t\t\t\t_context.next = 4;\n\t\t\t\t\t\t\t\treturn res;\n\n\t\t\t\t\t\t\tcase 4:\n\t\t\t\t\t\t\t\tthis.result = _context.sent.data;\n\t\t\t\t\t\t\t\t_context.next = 10;\n\t\t\t\t\t\t\t\tbreak;\n\n\t\t\t\t\t\t\tcase 7:\n\t\t\t\t\t\t\t\t_context.prev = 7;\n\t\t\t\t\t\t\t\t_context.t0 = _context[\"catch\"](0);\n\n\n\t\t\t\t\t\t\t\talert(_context.t0);\n\n\t\t\t\t\t\t\tcase 10:\n\t\t\t\t\t\t\tcase \"end\":\n\t\t\t\t\t\t\t\treturn _context.stop();\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}, _callee, this, [[0, 7]]);\n\t\t\t}));\n\n\t\t\tfunction getResults() {\n\t\t\t\treturn _ref.apply(this, arguments);\n\t\t\t}\n\n\t\t\treturn getResults;\n\t\t}()\n\t}]);\n\treturn Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./search.js?");

/***/ }),

/***/ 0:
/*!********************************************!*\
  !*** multi babel-polyfill ./controller.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./controller.js */\"./controller.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./controller.js?");
